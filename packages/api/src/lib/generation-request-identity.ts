...
export const DEFAULT_WEEKLY_REPORT_TITLE = 'Torchiko Weekly Report'
export const LEGACY_DEFAULT_WEEKLY_REPORT_TITLES = [
  'Torchico Weekly Report',
  'PathFinder Weekly Report',
] as const
