...
function fixture() {
  const raw = 'NON-SALES reply check: caf\u00e9 \u{1f33f}.\r\n\r\nOn Monday someone wrote:\r\n> retained old diagnostic'
  const native = {
    snapshotHash: 'a'.repeat(64), organization: { id: 'SYN-org' },
    venue: { id: 'SYN-venue', name: 'SYN diagnostic record', city: null, region: null, website: null },
    sources: [{ id: 'SYN-source', sourceType: 'fixture', sourceLabel: 'Synthetic', sourceUrl: null, createdAt: '2026-09-21' }],
    importRecords: [{ id: 'SYN-import', rawPayload: { _source: { sheetName: 'Synthetic', originalRowNumber: 1 } } }],
    threads: [{ id: 'SYN-thread', lastMessageAt: '2026-09-21', _count: { messages: 1 }, providerMappings: [{
      providerAccountId: 'SYN-account', providerThreadId: 'SYN-provider-thread',
      providerAccount: { provider: 'FAKE', mailboxAddress: 'fixture@example.invalid', connectionStatus: 'DISCONNECTED',
        credentialReferenceId: 'DO-NOT-EXPORT', accessToken: 'DO-NOT-EXPORT' },
    }], messages: [{ id: 'SYN-message', textBody: raw, bodyPreview: 'old preview',
      sourceReference: 'synthetic:raw-owner', bodyRetentionState: 'TEMPORARY',
      inboundReplyDisposition: 'UNREVIEWED', inboundReplyReviewId: null }]}],
  }
  return { native, raw }
}
