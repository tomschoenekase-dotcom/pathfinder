...
export function resolveGuestConversationDispositionPolicy(version: string, sha256: string) {
  ...
  return JSON.parse(GUEST_CONVERSATION_DISPOSITION_POLICY_CANONICAL) as typeof policy
}
