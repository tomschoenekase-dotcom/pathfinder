...
const VIEWS: Record<ClientPortalLifecycle, Omit<ClientPortalLifecycleView, 'version' | 'state'>> = {
  SETUP_REQUESTED: {
    ...
    headline: 'Let’s start building your Torchiko experience.',
    summary: 'Share the information you already have. The Torchiko team will handle the setup.',
  ...
  INTERNAL_REVIEW: {
    label: 'Torchiko review',
    headline: 'Your Torchiko experience is being carefully reviewed.',
  ...
  CLIENT_PREVIEW: {
    label: 'Preview ready',
    headline: 'Your Torchiko experience is ready for you to preview.',
  ...
  READY: {
    ...
    headline: 'Your Torchiko experience is ready for a final look.',
    summary: 'Preview the visitor experience. The Torchiko team will coordinate launch timing.',
    clientAction: 'OPEN_PREVIEW',
    clientActionRequired: true,
  },
  LIVE: {
    label: 'Live',
    headline: 'Your visitors can explore with Torchiko now.',
    summary:
  ...
  PAUSED: {
    label: 'Paused',
    headline: 'Your Torchiko experience is currently paused.',
    summary:
  ...
  OFFBOARDING: {
    ...
    headline: 'Your Torchiko service is being closed carefully.',
    summary: 'The Torchiko team will keep you informed about access and any requested handoff.',
    clientAction: 'NONE',
    clientActionRequired: false,
  },
}
