...
const VIEWS: Record<ClientPortalLifecycle, Omit<ClientPortalLifecycleView, 'version' | 'state'>> = {
  SETUP_REQUESTED: {
    ...
    headline: 'Let’s start building your Torchiko.',
  ...
  INTERNAL_REVIEW: {
    ...
    headline: 'Your Torchiko is being carefully reviewed.',
  ...
  CLIENT_PREVIEW: {
    label: 'Preview ready',
    headline: 'Your Torchiko is ready for you to preview.',
  ...
  READY: {
    ...
    headline: 'Your Torchiko is ready for a final look.',
  ...
  PAUSED: {
    label: 'Paused',
    headline: 'Your Torchiko is currently paused.',
    summary:
