-- Admit proposal-only support triage through the existing fail-closed credential
-- evidence trigger. This capability records a review item only; it cannot mutate
-- a support request, change client activity, contact a customer, or execute triage.
