-- Admit one approval-bound, attachment-free internal support note through the
-- existing fail-closed credential evidence trigger. This does not issue or
-- activate a credential, contact a customer, change request state or triage,
-- add a participant, or execute package lifecycle work.
