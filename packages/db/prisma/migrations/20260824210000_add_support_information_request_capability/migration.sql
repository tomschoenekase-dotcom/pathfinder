-- Admit approval-gated in-app support information requests through the existing
-- fail-closed credential evidence trigger. Proposal creation is mutation-free;
-- execution still requires an exact one-shot grant and performs no external delivery.
