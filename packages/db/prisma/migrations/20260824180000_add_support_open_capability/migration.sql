-- Admit one approval-bound DRAFT-to-OPEN support transition through the
-- existing fail-closed credential evidence trigger. This does not issue or
-- activate a credential, add a participant, send a message, or grant any later
