...
-- Retention disposition previews are count-only and client-scoped. Admit a
-- dedicated least-privilege capability without granting any disposition,
-- deletion, anonymization, revocation, provider, or approval authority.
