  ...
  items: [
    {
      ...
      evidence: [
        ...
        },
        {
          ...
          reference: 'https://example.com/arrival-walkthrough',
          summary: 'At 1:34, the walkthrough identifies the south doors as the main arrival point.',
          kind: 'VIDEO_TIMESTAMP',
          timestampSeconds: 94,
        },
      ],
      proposedAnswer: {
        interpretation: 'Treat the document as North Campus',
        confidence: 0.58,
        candidateEntities: [
          {
            label: 'North Campus',
            entityType: 'venue',
            reference: 'venue-candidate:north-campus',
            summary: 'Named on the handbook cover and in the retained upload metadata.',
          },
          {
            label: 'South Campus',
            entityType: 'venue',
            reference: 'venue-candidate:south-campus',
            summary: 'Named in the walkthrough and handbook footer.',
          },
        ],
        answerConsequences: [
          {
            answer: 'North Campus',
            consequence: 'Continue the linked review with North Campus as the venue identity.',
          },
          {
            answer: 'South Campus',
            consequence: 'Rebind the retained claims to South Campus before review continues.',
          },
        ],
      },
      blocking: true,
