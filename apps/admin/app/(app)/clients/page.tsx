      ...
      <section className="rounded-[2rem] bg-slate-950 px-8 py-10 text-white shadow-sm">
        ...
        <div className="mt-4 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <div className="rounded-[1.5rem] bg-white/10 px-5 py-4">
            <p className="text-xs uppercase tracking-[0.2em] text-cyan-300">Total clients</p>
      ...
      <section className="space-y-4">
        {clients.length === 0 ? (
          <div className="rounded-[1.75rem] border border-dashed border-slate-300 bg-slate-50 p-10 text-center">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950">No clients yet</h2>
              ...
              >
                <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                  ...
                  <Link
                    ...
                    className="inline-flex min-h-11 items-center rounded-full bg-slate-950 px-5 text-sm font-medium text-white transition hover:bg-slate-800"
                  >
                    Manage
                  </Link>
                </div>
