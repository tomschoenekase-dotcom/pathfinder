...
The reviewed 192-migration state contains 218 public tables: the B.5 boundary contains 193 and the
subsequent 51-migration suffix adds 25. The post-migration guard freezes that exact topology along
