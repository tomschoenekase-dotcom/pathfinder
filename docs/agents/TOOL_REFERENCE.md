...
agent/developer coverage, and exact binding state. The current 405-operation inventory contains 6
direct-tool bindings, 105 bounded alternatives, and 294 explicit unbound gaps. A binding is rejected
