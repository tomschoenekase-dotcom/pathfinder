...
7. **Partially closed — exact operation inventory and binding measurement.** The tool-coverage gate now
   ...
   router. A second reviewed digest now maps 6 operations to direct tools, 113 to deliberately
