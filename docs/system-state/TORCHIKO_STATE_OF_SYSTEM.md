...
| Current release evidence   | Local candidate `55408c4759b2fe9ccfe977e45abbe4800cc05cc5`: 226 migrations and 253 public tables measured on native disposable PostgreSQL in UTC. Retained September 2 hosted evidence records `a3e66de5...` at 207/207 migrations and 232 tables; this local campaign has not deployed its candidate. |
...
- `packages/db`: integrated Prisma schema, 226 migrations, tenant middleware, auditable domain actions, raw SQL, lifecycle helpers.
...
The current local candidate `55408c4759b2fe9ccfe977e45abbe4800cc05cc5` freezes 226 migrations ending at `20260907022600_add_intake_v1_package_handoffs`, with normalized manifest SHA-256 `033233483cdf5c89f5afecd2eb622f93802b228b0b5b9f11400e05f7254b4bbd`. Native disposable PostgreSQL 16.15 in UTC measured 226 completed ledger rows and 253 public tables; the V1 transaction fixture passed and its server stopped. [Evidence](../evidence/intake-v1-package-native-postgres-2026-09-07.json) retains measured source copies, logs, and data. Earlier Docker resource cleanup remains unverified.
