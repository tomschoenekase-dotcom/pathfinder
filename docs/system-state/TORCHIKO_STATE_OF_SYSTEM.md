...
Current isolated source candidate, 2026-09-24: 254 migrations end at `20260923014500_prospect_county_research_leases` with manifest SHA-256 `57cb04a4165c78db2be8ea0bd2e9eea72527a1f8fd5bf298efb7a7dbfbf3d112`. This source has 477 approved bypass calls in 166 production files and 252 raw-SQL operations (151 reads, 101 writes). The last hosted staging observation below remains the 250-migration release; this source extension has not been admitted or deployed. Its four added migrations belong to the native prospect workflow integration and require the staging migration hold, backup, restore proof, and release checks before rollout.
