...
| Knowledge | Legacy Place/knowledge                      | LEGACY / SUPERSEDED          | `place.ts`, `knowledge.ts`, `legacy-content-actions.ts`                                                                                                                           | Still functional                               | Semantic retrieval still depends on it; exact native-head convergence is measurable, but no read switch or retirement is authorized.                                                                       |
| Knowledge | Native module/revision/publication model    | IMPLEMENTED BUT NEEDS POLISH | content models/actions, manifests, native deployments, convergence measurement                                                                                                    | Strong but complex                             | Exact missing/invalid/drifted/in-sync head evidence is available; shadow relevance parity and the cutover/rollback contract remain open.                                                                   |
