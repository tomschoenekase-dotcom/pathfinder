...
Final launch review, 2026-09-18: the current local source contains 250 migrations ending at `20260918190000_add_agent_routines`, with 267 public tables and LF-normalized manifest SHA-256 `9a8d7747ac94edeb3eb2b60aabbe661e23c3f360d5f48f657591dcff08e837be`. The frozen 249/265 predecessor ends at `20260912080000_add_guest_conversation_disposition` with manifest SHA-256 `4eff7f0a42a6cce1e695f7bc9bcd5b90a8b7534b1e3f0b11f59bfc6e618f9736`; deterministic source admission covers only that exact suffix, replay, and ledger refusal. It does not claim a native populated rehearsal, hosted migration, backup, restore, or production readiness. The [latest retained staging integrity evidence](../evidence/staging-249-integrity-2026-09-18.json) binds successful staging-web deployment `6c5976d6-14ff-4723-9f36-fe94bebb2a21` to revision `7435a56943a9438edf33f2878c6e37e95b3b264e`; its predeploy log records the exact 249-file manifest and 249-row ledger already complete with integrity checks passing. Migration 250 and the recurring-worker code have not yet reached staging. Earlier 207-row archive and restore/upgrade evidence remains historical proof rather than current hosted state. A fresh release-bound preservation backup/restore, held migration, code rollout, and hosted journey inspection remain pending. Historical snapshots below retain their recorded revision limits. Production publication is prohibited for this mission.
...
| Technical   | Two content/deployment generations coexist, and 449 approved tenant-isolation bypass calls plus 252 raw-SQL operations increase review burden.    |
