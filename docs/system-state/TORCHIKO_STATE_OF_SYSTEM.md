...
Final launch review, 2026-09-10: the current local source contains 247 migrations ending at `20260910140000_add_semantic_reviewed_decline`. Retained disposable proof measures 264 tables; the populated 236-to-247 rehearsal and exact candidate release admission remain pending. Read-only staging health on this date reports `ecd7d07f3f9e7af97f3db31990b37849667598ed`, with the expected database/Redis/storage fingerprints and database/queue up. This is the prior staging deployment, not publication of the current candidate. Historical snapshots below retain their recorded revision limits. Production remains stopped.
