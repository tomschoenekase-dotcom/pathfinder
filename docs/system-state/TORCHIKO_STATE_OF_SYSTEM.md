...
| Current release evidence   | Local candidate `1e84eee2bb99912ca7aa44382ed17eb9f4f68a88`: 224 migrations and 251 public tables measured on native disposable PostgreSQL in UTC. Retained September 2 hosted evidence records `a3e66de5...` at 207/207 migrations and 232 tables; this local campaign has not deployed its candidate. |
...
- `packages/db`: integrated Prisma schema, 224 migrations, tenant middleware, auditable domain actions, raw SQL, lifecycle helpers.
...
The current local candidate `1e84eee2bb99912ca7aa44382ed17eb9f4f68a88` freezes 224 migrations ending at `20260907022400_add_intake_v1_submissions`, with normalized manifest SHA-256 `8ce5fbb7e14ea3c57d6b68895d742b59e455dbc68316db7bb101bb7858fd1532`. Native disposable PostgreSQL 16.15 in UTC measured 224 completed ledger rows and 251 public tables; the V1 transaction fixture passed and its server stopped. [Evidence](../evidence/intake-v1-native-postgres-2026-09-07.json) retains measured source copies, logs, and data. Earlier Docker resource cleanup remains unverified.
