...
| Current release evidence   | Local candidate `d6ed6a2d...`: 218 migrations and 243 public tables measured on disposable PostgreSQL. Retained September 2 hosted evidence records `a3e66de5...` at 207/207 migrations and 232 tables; this local campaign has not deployed its candidate. |
...
| Technical   | Two content/deployment generations coexist, and 409 approved tenant-isolation bypass calls plus 146 raw-SQL operations increase review burden.    |
...
- `packages/db`: integrated Prisma schema, 218 migrations, tenant middleware, auditable domain actions, raw SQL, lifecycle helpers.
