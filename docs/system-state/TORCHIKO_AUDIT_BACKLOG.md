...
- **Evidence:** evaluation models/contracts/worker/admin; low-confidence heuristic and answer-analysis worker.
- **Affected system:** AI quality, reporting, operations.
- **Recommended change:** Create venue-specific golden questions, adversarial/out-of-scope cases, citation/retrieval metrics, regression baselines, sampling from sanitized production failures, and human-review calibration.
