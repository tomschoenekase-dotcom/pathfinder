...
- **Evidence:** no RLS policies found; 451 approved bypasses across 157 production files; 253 raw-SQL operations. Current-truth tests derive these counts from the executable boundary verifiers so inventory drift cannot silently leave the audit understated.
