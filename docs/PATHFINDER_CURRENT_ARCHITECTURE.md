...
| Media ingestion lab                      | Built, admin-only, experimental                                                                                          | `admin/media-ingestion.ts`, `apps/workers/src/processors/media-ingestion.ts`        | High                           | Bounded Zod validation and reviewed model IDs are present; project cost fields remain unpopulated | Add versioned media usage/cost accounting after approving a commercial budget policy           |
