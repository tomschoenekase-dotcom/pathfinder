...
const approvedCallCounts = new Map([
  ...
  ['packages/api/src/routers/admin/media-ingestion-abort.ts', 2],
  ['packages/api/src/routers/admin/media-ingestion-complete-upload.ts', 5],
  ['packages/api/src/routers/admin/media-ingestion-expiry.ts', 3],
  ['packages/api/src/routers/admin/media-ingestion-finalization.ts', 3],
  ['packages/api/src/routers/admin/media-ingestion-lifecycle.ts', 7],
  ['packages/api/src/routers/admin/media-ingestion-projects.ts', 9],
  ...
  ['packages/api/src/routers/admin/weekly-reports.ts', 6],
