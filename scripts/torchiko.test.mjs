...
test('every mounted router has exactly one explicit agent/developer coverage decision', async () => {
  ...
  assert.equal(report.operations.total, 381)
  ...
  assert.equal(report.operations.counts.byKind.query, 167)
  assert.equal(report.operations.counts.byKind.mutation, 214)
