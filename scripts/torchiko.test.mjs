...
test('every mounted router has exactly one explicit agent/developer coverage decision', async () => {
  ...
  assert.equal(report.operations.total, 376)
  ...
  assert.equal(report.operations.counts.byKind.query, 166)
  assert.equal(report.operations.counts.byKind.mutation, 210)
