...
const suites = [
  {
    ...
    args: [
      ...
      'components/billing/ClientBillingView.test.tsx',
      'components/admin/AdminBillingView.test.tsx',
      'components/admin/AdminBillingPortfolio.test.tsx',
      'components/WeeklyReportContent.test.tsx',
      'app/(app)/layout.test.tsx',
      'app/(app)/weekly-reports/page.test.tsx',
      'app/(app)/weekly-reports/[reportId]/page.test.tsx',
